    ...
    def create(self, *args, **kwargs):
        ...
        for i in range(0, n):
            ...
            for prompt in prompts:
                lls_result = self.inference_api.completion(
                    model_id=model_id,
                    content=prompt,
...
class Chat:
    ...
    def __init__(self, inference_api):
        self.inference_api = inference_api
        self.completions = ChatCompletions(self.inference_api)
...
class OpenAIClientAdapter:
    ...
    def __init__(self, inference_api, models_api):
        self.inference_api = inference_api
        self.models_api = models_api

        self.completions = Completions(self.inference_api)
        self.chat = Chat(self.inference_api)
        self.models = Models(self.models_api)
